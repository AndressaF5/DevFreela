...
namespace DevFreela.UnitTests.Fakes
{
    public class FakeDataHelper
    {
        ...
        private static readonly Faker<Project> _projectFaker = new Faker<Project>()
            .CustomInstantiator(f => new Project(f.Commerce.ProductName(),
                f.Lorem.Sentence(),
                f.Random.Int(1, 100),
                f.Random.Int(1, 100),
        ...
        private static readonly Faker<InsertProjectCommand> _insertProjectCommandFaker = new Faker<InsertProjectCommand>()
            ...
            .RuleFor(c => c.TotalCost, f => f.Random.Decimal(1, 100));
        ...
        public static InsertProjectCommand CreateFakerInsertProjectCommand() => _insertProjectCommandFaker.Generate();
